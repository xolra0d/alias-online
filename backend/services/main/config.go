...
func LoadServerConfig() *ServerConfig {
	...
	vocabsURLGateway := config.GetEnvOrExit("VOCABS_URL_GATEWAY")
	authURLGateway := config.GetEnvOrExit("AUTH_URL_GATEWAY")
	roomManagerURLGateway := config.GetEnvOrExit("ROOM_MANAGER_URL_GATEWAY")
	...
	return &ServerConfig{
		...
		VocabsURLGateway:      vocabsURLGateway,
		AuthURLGateway:        authURLGateway,
		RoomManagerURLGateway: roomManagerURLGateway,
